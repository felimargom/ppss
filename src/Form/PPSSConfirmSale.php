  ...
  public function buildForm(array $form, FormStateInterface $form_state)
  {
    ...
    if (!(is_null($node))) {
      ...
      if (!(is_null($payment_id))) {
        ...
        \Drupal::logger('PPSS')->error('Try to create a new Agreement with this token: '.$token);
      ...
      if(isset($objPayment)) {
        ...
        \Drupal::messenger()->addError('Lo sentimos, por el momento su pago no puede ser completado, verifique su cuenta de PayPal');
      }
    }
